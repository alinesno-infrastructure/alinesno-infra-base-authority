package com.alinesno.infra.base.authority.identity.controller.mfa;

import com.alinesno.infra.base.authority.identity.domain.MfaVerityDto;
import com.alinesno.infra.base.authority.identity.totp.code.CodeVerifier;
...
public class MfaVerifyController {
    ...
    @Autowired
    private IManagerAccountService managerAccountConsumer ;
