package com.alinesno.infra.base.authority.identity.totp.autoconfigure;

import com.alinesno.infra.base.authority.identity.totp.TotpInfo;
import com.alinesno.infra.base.authority.identity.totp.code.*;
import com.alinesno.infra.base.authority.identity.totp.qr.QrDataFactory;
import com.alinesno.infra.base.authority.identity.totp.qr.QrGenerator;
import com.alinesno.infra.base.authority.identity.totp.qr.ZxingPngQrGenerator;
import com.alinesno.infra.base.authority.identity.totp.recovery.RecoveryCodeGenerator;
import com.alinesno.infra.base.authority.identity.totp.secret.DefaultSecretGenerator;
import com.alinesno.infra.base.authority.identity.totp.secret.SecretGenerator;
import com.alinesno.infra.base.authority.identity.totp.time.SystemTimeProvider;
