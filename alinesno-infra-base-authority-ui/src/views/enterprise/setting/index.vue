...
import { listSetting, getSetting, delSetting, addSetting, updateSetting, listSettingExcludeChild } from "@/api/enterprise/setting";
...
function handleUpdate(row) {
  reset();
  listSettingExcludeChild(row.id).then(response => {
    deptOptions.value = proxy.handleTree(response.rows, "id");
  });
  getSetting(row.id).then(response => {
