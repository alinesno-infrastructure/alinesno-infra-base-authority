...
import { listTheme, getTheme, delTheme, addTheme, updateTheme, listThemeExcludeChild } from "@/api/enterprise/theme";
...
function handleUpdate(row) {
  reset();
  listThemeExcludeChild(row.id).then(response => {
    deptOptions.value = proxy.handleTree(response.rows, "id");
  });
