...
@Data
public class AuthManagerAccountDto extends BaseDto {
	// fields
	/**
	 * "账户状态"
	 */
	 ...
	 */
	public AuthManagerAccountDto mapToDto() {
		ObjectMapper toDtoMapper = new ObjectMapper();
		toDtoMapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
		return toDtoMapper.convertValue(this, AuthManagerAccountDto.class);
	}
	 ...
	 * @return dto 对应的 entity
	 */
	public AuthManagerAccountDto fromDto(ManagerAccountEntity entity) {
		ObjectMapper fromDtoMapper = new ObjectMapper();
		fromDtoMapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
		return fromDtoMapper.convertValue(entity, AuthManagerAccountDto.class);
	}
