...
/**
 * 处理与SysDeptEntity相关的请求的Controller。
 * 继承自BaseController类并实现ISysDeptService接口。
 *
 * @author LuoXiaoDong
 * @version 1.0.0
 */
...
@RequestMapping("/api/infra/base/authority/sys_dept")
public class SysDeptController extends BaseController<SysDeptEntity, ISysDeptService> {
    ...
    @Override
    public ISysDeptService getFeign() {
        return this.service;
    }
}