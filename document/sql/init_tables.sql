...
CREATE TABLE `basic_resources` (
    ...
    `tenant_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '租户ID',
...
CREATE TABLE `enterprise` (
    ...
    `tenant_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '所属租户',
    `update_time` datetime DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `manager_position` (
    ...
    `tenant_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
    `update_time` datetime DEFAULT NULL COMMENT '最后更新时间',
