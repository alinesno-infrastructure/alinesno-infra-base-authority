...
CREATE TABLE `content_comments` (
    ...
    `group_id` bigint DEFAULT NULL COMMENT '所属组织',
...
CREATE TABLE `basic_resources` (
    ...
    `group_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '组织ID',
...
CREATE TABLE `enterprise` (
    ...
    `group_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '所属组织',
    `update_time` datetime DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `manager_group` (
    ...
    `application_name` varchar(100) DEFAULT NULL COMMENT '应用名称',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='管理员组织';
...
CREATE TABLE `manager_group_log` (
    ...
    `application_name` varchar(100) DEFAULT NULL COMMENT '应用名称',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='管理员组织日志';
