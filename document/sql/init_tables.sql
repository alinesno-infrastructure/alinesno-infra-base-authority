...
CREATE TABLE `content_comments` (
    ...
    `group_id` bigint DEFAULT NULL COMMENT '所属机构',
...
CREATE TABLE `basic_resources` (
    ...
    `application_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '应用ID',
    ...
    `department_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '部门ID',
    `field_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '字段ID',
    ...
    `last_update_operator_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最后更新操作员ID',
    `operator_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '操作员ID',
    `group_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '机构ID',
...
CREATE TABLE `enterprise` (
    `id` bigint NOT NULL COMMENT '主键',
    `add_time` datetime DEFAULT NULL COMMENT '添加时间',
    `application_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '所属应用',
    `delete_manager` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '删除人员',
    `delete_time` datetime DEFAULT NULL COMMENT '删除时间',
    `department_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '部门权限',
    `field_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '字段权限',
    `field_prop` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '字段属性',
    `has_delete` int NOT NULL COMMENT '是否删除',
    `has_status` int NOT NULL COMMENT '状态',
    `last_update_operator_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '最后更新操作员',
    `operator_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '操作员',
    `group_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '所属机构',
    `update_time` datetime DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `enterprise_account` (
    ...
    `group_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '所属机构',
    `update_time` datetime DEFAULT NULL COMMENT '最后更新时间',
    `enterprise_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '企业ID',
    `account_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '账号ID',
    `credit_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '信用代码',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `manager_account` (
    ...
    `cas_account_id` bigint DEFAULT NULL COMMENT 'cas用户Id',
    PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `manager_files` (
    ...
    `business_key_id` bigint DEFAULT NULL COMMENT '业务键ID',
...
CREATE TABLE `manager_position` (
    ...
    `id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
    `add_time` datetime DEFAULT NULL COMMENT '添加时间',
    `application_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
    `delete_manager` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
    `delete_time` datetime DEFAULT NULL COMMENT '删除时间',
    `department_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
    `field_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
    `field_prop` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
    `has_delete` int NOT NULL,
    `has_status` int NOT NULL,
    `last_update_operator_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
    `operator_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
    `group_id` bigint CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
    `update_time` datetime DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `manager_group` (
    ...
    `group_cost` int DEFAULT NULL,
    `group_name` varchar(100) DEFAULT NULL,
    `group_phone` varchar(100) DEFAULT NULL,
    ...
    `application_name` varchar(100) DEFAULT NULL COMMENT '应用名称',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='管理员机构';

-- ----------------------------
-- Table structure for manager_group_log
-- ----------------------------
DROP TABLE IF EXISTS `manager_group_log`;
CREATE TABLE `manager_group_log` (
    `id` bigint NOT NULL COMMENT '主键',
    `add_time` datetime DEFAULT NULL COMMENT '添加时间',
    `application_id` bigint DEFAULT NULL COMMENT '所属应用',
    `delete_manager` varchar(100) DEFAULT NULL COMMENT '删除人员',
    ...
    `end_time` date DEFAULT NULL,
    `log_business_id` bigint DEFAULT NULL,
    ...
    `application_name` varchar(100) DEFAULT NULL COMMENT '应用名称',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='管理员机构日志';
